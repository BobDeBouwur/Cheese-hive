...
module.exports.run = async (bot, message, args) => {
    ...
    if (!kickUser) return message.reply("Helaas ik kan deze gebruiker niet vinden!");

    if (kickUser.permissions.has("MANAGE_MESSAGES")) return message.reply("Je kan deze gebruiker niet kicken");
    ...
    var embedPrompt = new discord.MessageEmbed()
        ...
        .setDescription(`${kickUser} kicken?`);

    var embed = new discord.MessageEmbed()
        .setColor("DARK_RED")
        .setDescription(`**Gekicked:** ${kickUser} 
...
module.exports.help = {
    name: "kick",
    category: "general",
    description: "Hiermee kick je een gebruiker",
    aliases: []
}